        ...
        set: {
          ...
          type: function() {
            if(module.can.fit()) {
              ...
              //legendjw 超出大小只设置内容滚动
              var otherHeight = ($module.children('.actions').length > 0 ? 48 : 0) + ($module.children('.header').length > 0 ? 48 : 0);
              var contentHeight = module.cache.pageHeight - otherHeight;
              $module.children('.content').css({
